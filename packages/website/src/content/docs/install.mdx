---
title: Install
description: Install PlanBridge and configure it for the harnesses on your machine.
---
...
This detects every supported AI coding harness on your machine and adds the review hooks. The curl one-liner runs this for you; both manual paths leave it as a separate step. See [the installer reference](/cli/install/) for flags and per-harness targeting.

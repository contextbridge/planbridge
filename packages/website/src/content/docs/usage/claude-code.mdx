...
If you have our Claude Code hooks installed (via `contextbridge install`), every time Claude finishes planning and asks to proceed, PlanBridge intercepts and opens your browser for review.

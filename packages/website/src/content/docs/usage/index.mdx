...
**As a manual action.** You invoke `/planbridge-open <path>` in Claude Code or `$planbridge-open <path>` in Codex CLI and your agent opens any markdown file in the browser for review. See [Open arbitrary content](/usage/open/).
